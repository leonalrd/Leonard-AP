...
<form method="post" action="" class="form-horizontal" role="form">
	<div class="form-group">
		<label for="jenis" class="col-sm-2 control-label">Jenis Paket Cuci</label>
		<div class="col-sm-4">
			<input type="hidden" name="id_biaya" value="<?php echo $row['id_biaya']; ?>">
			<input type="text" class="form-control" id="jenis" value="<?php echo $row['jenis']; ?>" name="jenis" placeholder="Jenis Paket Cuci" required>
		</div>
	</div>
	<div class="form-group">
